...
<div class='s2-container'>
  <div class='s2-container__content'>
    <p class='text text_colored'>Who Would You Choose as Your First Partner, if you play right now?</p>
  </div>
  <div class="swiper">
  ...
  <button id='step2-btn' class='btn btn_accept btn_slider' type='button'>next</button>
</div>
`;
