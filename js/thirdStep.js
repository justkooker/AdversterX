  ...
  <div class='lady lady_1'> <picture><source srcset='../assets/img/lady4.png' media="(min-width: 850px)" />
    <img src="../assets/img/lady4-mob.png" alt="lady4" />
      ...
      <div class='s3-container__content'>
          ...
          <p class='text text_white'>You must be at least 18 years old and comfortable with mature topics to play the game.</p>
      </div>
      <button id='step3-btn' class='btn btn_accept' type='button'>Ok, Continue</button>
</div>
`;
